...
/*
* search scope is only the vertices at depx
*/

#define maxn 200005
vi g[maxn];
vi parent,dep,posible;
int depx;
...
int main()
{
    ...
    while(true){
        ...
        else if(siz(posible)==2){
            if(query('d',posible[0])){
                cout<<"! "<<posible[1]<<endl;
            }
            else cout<<"! "<<posible[0]<<endl;
            return 0;
        }
        int u=posible[siz(posible)/2];
        int depy=depx-query('d',u)/2;
