...
bool win[total_len],los[total_len];
...
int main()
{
    ...
    if(win[root.ff] and los[root.ff]) output(true);
    else if(!win[root.ff]) output(false);
    else if(win[root.ff] and !los[root.ff]) output(k%2==1);
