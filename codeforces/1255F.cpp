...
int main() {
    ...
    vector<pair<ld, int> > up, down, up1, up2, down1, down2;
    ...
    if (!down.empty()) {
        int pv = down[siz(down) - 1].ss;
        for (int i = 0; i < siz(down) - 1; i++) {
            cout << 2 << " " << 1 << " " << pv << " " << down[i].ss << endl;
            cout << flush;
            int sign;
            cin >> sign;
            if (sign == -1) {
            ...
            else down2.pb(down[i]);
        }
        down1.pb(down[siz(down) - 1]);
    }

    if (!up.empty()) {
        int pv = up[siz(up) - 1].ss;
        for (int i = 0; i < siz(up) - 1; i++) {
            cout << 2 << " " << 1 << " " << pv << " " << up[i].ss << endl;
            cout << flush;
            int sign;
            cin >> sign;
            if (sign == -1) {
