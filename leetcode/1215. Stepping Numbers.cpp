...
public:
    ...
    void func(int cnt, int nowcnt, int last, ll val) {
        if (cnt == nowcnt) {
            ans.pb(val);
        }
        else {
            ...
            int high = last + 1;
            if (low >= 0) {
                func(cnt, nowcnt + 1, low, val * 10 + low);
            }
            if (high <= 9) {
                func(cnt, nowcnt + 1, high, val * 10 + high);
            }
        }
    }
