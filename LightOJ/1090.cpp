...
int main()
{
    ...
    for(int i=1;i<=t;i++){
        ...
        cout<<min(facts[n].ff-facts[n-r].ff-facts[r].ff+q*twofives[p].ff,
                  facts[n].ss-facts[n-r].ss-facts[r].ss+q*twofives[p].ss)<<endl;
    }
